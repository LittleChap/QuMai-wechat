  ...
  <div>
    ...
    <div v-for="item, index in orderInfo.orderItemArray" :key="index" class="mb10 bdb">
      ...
      <div class="bgw bdb p24">
        ...
        <div class="dsf fww">
          <img :src="i.image"
               v-for="i,idx in JSON.parse(item.orderItemComment.images)"
               :key="idx"
               class="commenImg"
      ...
      <div class=" bgw red plr24 lh66 f28">
        追加评论<div class="bdb w100"></div>
      </div>
      <!--中间 评价的文本框 开始-->
      <div class="bgw">
    ...
    <div class="publishBtn" @click="appendEvaluateOrder">发表评论</div>
